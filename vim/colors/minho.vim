...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  " #ffffff, #1c1c1c
  call <SID>X("Normal", "ffffff", "1c1c1c", "")
  ...
  call <SID>X("LineNr", "666666", "1a1a1a", "", "239")
  ...
  call <SID>X("WarningMsg", "fa8072", "", "bold")
  ...
  call <SID>X("Comment", "87ceeb", "", "italic")
  call <SID>X("Constant", "ff8080", "", "")

  "python: Function/None/True,False
  call <SID>X("Identifier", "40f0f0", "", "none")

  "python : def, class
  call <SID>X("Statement", "ffc864", "", "")

  "python : import
  call <SID>X("PreProc", "ffa0ff", "", "")

  call <SID>X("Type", "6bb42a", "", "bold")
  call <SID>X("Special", "ffc266", "", "")

  "call <SID>X("Number", "a0e860", "", "")
  call <SID>X("Number", "ffa0ff", "", "")
